...
NYDATA2<-NYDATA[-grep("not listed", NYDATA$County),]
NYDATA3<-NYDATA2[-grep("Lake Erie Open Waters", NYDATA2$County),]
NYDATA4<-NYDATA3[-grep("Counties Unknown", NYDATA3$County),]
NYDATA5<-NYDATA4[-grep("Atlantic Ocean and Long Island Sound", NYDATA4$County),]
NYDATA6<-NYDATA5[-grep("Lake Ontario Open Waters", NYDATA5$County),]
#62 counties after cleaning. 
#Calling final dataset as something better
NYDATA_Clean<-NYDATA6
...
NYDATA_AnimalsPlants <- NYDATA6[ which(NYDATA6$Category!='Natural Community'),]
NYDATA_NatCom<- NYDATA6[ which(NYDATA6$Category=='Natural Community'),]
...
table(NYDATA_AnimalsPlants$Taxonomic.Group, NYDATA_AnimalsPlants$Federal.Listing.Status)
# Do you notice any weird taxonomic groups from your table? 
# Remove those entries.
NYDATA_AnimalsPlants_Clean<-NYDATA_AnimalsPlants[-grep("Animal Assemblages", NYDATA_AnimalsPlants$Taxonomic.Group),]
table(NYDATA_AnimalsPlants_Clean$Taxonomic.Group, NYDATA_AnimalsPlants_Clean$Federal.Listing.Status)
# Check the dimensions of each data frame. How many entries do we have for each?
dim(NYDATA_AnimalsPlants_Clean)
dim(NYDATA_NatCom)
```
